...
function TDI_import_files() {
	return array(
		array(
			'import_file_name'           => 'Parallel Lite Demo Content',
			'import_file_url'            => 'https://www.themely.com/download/demo/parallel-lite/content.xml',
			'import_widget_file_url'     => 'https://www.themely.com/download/demo/parallel-lite/widgets.wie',
			'import_customizer_file_url' => 'https://www.themely.com/download/demo/parallel-lite/settings.dat',
		),
	);
}
