<div id="getting_started" class="parallel-tab-pane">
    <div class="left">
        <div>
            ...
            <ol>
                ...
                <li><?php esc_html_e('Install', 'parallel'); ?> <a target="_blank" href="<?php echo esc_url('https://wordpress.org/plugins/theme-demo-import/'); ?>"><?php esc_html_e('Theme Demo Importer', 'parallel'); ?></a> <?php esc_html_e('plugin', 'parallel'); ?></li>
            </ol>
            <p>
        ...
        <div>
            <h3><?php esc_html_e('Step 2 - Configure One-Page Template', 'parallel'); ?></h3>
            <ol>
    ...
    <div class="right">
        <div class="upgrade">
            ...
            <p class="red"><strong><?php esc_html_e('Save 15% with coupon code', 'parallel'); ?> <span class="border-red"><?php esc_html_e('THEMELY15', 'parallel'); ?></span></strong></p>
            <ul class="ul-square">
